...
# Pratik teshis: t1 hedefini launcher ILE DEGIL, python'un
...
# zaten 7.5.9.1'den 238 govde aldik. Token esleme + dnlib geri
# yazim: nb2 dosyasi acilir (metadata gorunur), dump'taki IL
# pattern'leriyle eslenir. Once dump dosyalarindan biri ile
# nb2'deki metotlari karsilastir — IL hash eslemesi mumkun mu:
...
print('dump:', len(bins))
# ilk 3 govdenin IL'ini hex yaz — dnlib tarafinda esleme icin
for f in bins[:3]:
    d = open(f, 'rb').read()
